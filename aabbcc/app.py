    ...
    [
        ...
        dbc.Nav(
            [
                ...
                dbc.NavLink("Информация о проекте", href="/page-4", active="exact"),
            ],
            vertical=True,
            pills=True,
        ),
...
def render_page_content(pathname):
    if pathname == "/":
        ...
        return mainInfo.layout
    
    # Если пользователь попытается перейти на другую страницу, вернем сообщение 404.
    return html.Div(
        [
