...
def update_stacked_area(club, indication, year):
    ...
    figure.update_layout(title_text='Столбчатая диаграмма с показателями футболистов по годам', paper_bgcolor='#000000', plot_bgcolor='#000000',font=dict(color='white'))
    return figure
...
def update_pie(club, indication, year):
    ...
    figure.update_layout(title_text='Круговая диаграмма с основными показателями футболистов', paper_bgcolor='#000000', plot_bgcolor='#000000',font=dict(color='white'))
